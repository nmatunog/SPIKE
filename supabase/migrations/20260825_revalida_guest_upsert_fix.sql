-- RA-SPIKE Revalida — fix guest rating upsert for partial unique index
-- Partial index revalida_panel_ratings_guest_squad_uidx requires matching ON CONFLICT predicate.
