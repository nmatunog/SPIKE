...
writeDayBundle('day-4', 4, {
  ...
  sessions: [
    { id: 'session-day-4-morning', sessionNumber: 1, title: 'Entrepreneur Paths & Canvas', durationMinutes: 140, presentationIds: ['presentation-day-4-deck-01', 'presentation-day-4-deck-02'], activityIds: ['activity-day-4-track-clinic', 'activity-day-4-canvas-workshop'], worksheetIds: [], assessmentIds: [], reflectionIds: [], surveyIds: [] },
