...
writeDayBundle('day-4', 4, {
  ...
  learningObjectives: [
    ...
    'Draft Unified Venture Proposition through Venture Design Studio',
    'Align UVP to career direction',
    'Prepare for Day 5 venture commitment',
  ],
  expectedOutputs: ['Unified Venture Proposition', 'Career Direction checkpoint', 'UVP presentation notes'],
  portfolioDeliverables: ['UVP & brand identity snapshot', 'Career direction update'],
  ...
  surveyQuestions: [
    ...
    { id: 'sq-day-4-02', prompt: 'How clear is your Unified Venture Proposition after today?', type: 'short_text', required: true },
  ],
  assessment: { id: 'assessment-day-4-canvas', title: 'Day 4 UVP & Venture Design Check', description: 'UVP drafted through Venture Design Studio.', rubricId: 'rubric-day-4-canvas' },
  rubric: { id: 'rubric-day-4-canvas', title: 'UVP Presentation Rubric', criteria: ['UVP drafted in Venture Design Studio (Step 3)', 'Clear who they serve and what problem they solve', 'Transformation / outcome articulated', 'Brand identity supports the proposition'] },
  ...
  activities: [
    ...
    activity('activity-day-4-canvas-workshop', 'FE Canvas Workshop', 75,
      ['Open Venture Design Studio from Playbook Day 4.', 'Complete steps with focus on Step 3 UVP synthesis.', 'Commit UVP to portfolio.'],
      ['Is your UVP clear in one sentence?', 'Does it match your ambition?', 'What will you refine before Day 5?'],
      ['Venture Design Studio in Playbook'],
      ['UVP in portfolio']),
  ...
  facilitator: {
    ...
    prepChecklist: ['Test Venture Design Studio access', 'Load Deck 01', 'Prepare FEC projection for UVP overview'],
    sessionFlow: [
      { time: '0:00–0:25', activity: 'Deck 01 intro + Venture Design Studio launch', notes: 'Deck 02 is in-app.' },
      { time: '0:25–0:65', activity: 'Track clinic', notes: 'Honest exploration.' },
      { time: '0:65–2:00', activity: 'Venture Design Studio workshop', notes: 'Target: drafted UVP (Step 3).' },
      { time: '2:00–2:40', activity: 'Peer review + presentations', notes: 'Coach UVP clarity.' },
    ],
    debriefQuestions: ['Who drafted a clear UVP?', 'Which path drew most energy?', 'Day 5 presentation prep?'],
    commonPitfalls: ['Chasing FEC completion instead of UVP', 'Generic customer segments', 'Skipping Step 3 synthesis'],
    coachingTips: ['Use proposition gaps as coaching prompts', 'Link UVP to persona and ambition'],
  },
  evaluations: [
    { id: 'rubric-day-4-canvas-complete', type: 'rubric', title: 'UVP & Venture Design Rubric', audience: 'faculty', description: 'Day 4 success = drafted UVP.', criteria: [{ label: 'Unified Venture Proposition', indicators: ['Clear customer segment', 'Problem and outcome articulated', 'UVP synthesis drafted (Step 3)', 'One-sentence explainable'] }], scale: ['Not drafted', 'Emerging UVP', 'Clear UVP', 'Exemplary UVP'] },
    { id: 'observation-day-4-faculty', type: 'observation_form', title: 'Program Coach Day 4 Observation', audience: 'faculty', observationAreas: ['UVP clarity', 'Customer insight', 'Squad consolidation'], fields: [{ id: 'uvp', label: 'UVP drafted and articulable', type: 'rating', max: 5 }, { id: 'notes', label: 'Notes', type: 'long_text' }] },
    { id: 'observation-day-4-mentor', type: 'observation_form', title: 'Mentor Day 4 Observation', audience: 'mentor', observationAreas: ['UVP Clarity', 'Ownership', 'Entrepreneurial Thinking'], fields: [{ id: 'uvp', label: 'UVP drafted', type: 'rating', max: 5 }, { id: 'ownership', label: 'Ownership', type: 'rating', max: 5 }, { id: 'coaching_note', label: 'Coaching note', type: 'long_text' }] },
  ],
  mentorGuide: {
    title: 'Mentor Guide — Day 4: Entrepreneur',
    coachingObjective: 'Coach squads to draft a clear Unified Venture Proposition.',
    timing: mentorTiming,
    discussionQuestions: ['Who does your venture serve?', 'What is your one-sentence UVP?', 'Would you rather build a Practice, Team, or Agency? Why?'],
    observationAreas: [
      { area: 'UVP Clarity', lookFor: ['Specific customer segment', 'Step 3 synthesis complete'], warningSigns: ['Generic customer'] },
      { area: 'Ownership', lookFor: ['Engages in Venture Design Studio'], warningSigns: ['Minimal effort'] },
      { area: 'Entrepreneurial Thinking', lookFor: ['Connects research to UVP'], warningSigns: ['Employee language'] },
    ],
    coachingTips: ['Day 4 target is UVP — not FEC completion %', 'Do not prescribe track — explore'],
    warningSigns: ['Skipping Step 3 UVP synthesis', 'Choosing positioning to please others'],
    reflectionPrompts: ['What is your one-sentence UVP today?'],
    expectedOutcomes: ['Unified Venture Proposition (Venture Design Studio)'],
    activityCoachingNotes: [{ activityId: 'activity-day-4-canvas-workshop', note: 'Coach at Step 3 — who they serve and how they win.' }],
    debriefWithFaculty: ['Who drafted a clear UVP?', 'Day 5 presentation pairs?'],
  },
});
