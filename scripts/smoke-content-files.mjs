...
const checks = [
  ...
  [presentation.presentation?.pptxUrl?.includes('/api/coach/faculty-deck/'), 'Deck 01 staff API pptxUrl'],
  [presentation.slides?.every((s) => s.imageUrl), 'Deck 01 slide images'],
  [existsSync(join(ROOT, 'content/segment-1/week-1/day-1/source/faculty-deck-01.pptx')), 'Deck 01 pptx in source'],
