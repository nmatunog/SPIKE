...
export const BLUEPRINT_MODULES = [
  ...
  },
  {
    ...
    tracks: ['agency_builder', 'specialist_consultant'],
    progressWeights: [
      { key: 'vision_statement', label: 'My Ambition', weight: 20 },
      { key: 'mission_statement', label: 'My Purpose', weight: 20 },
      { key: 'my_values', label: 'My Values', weight: 20 },
      { key: 'future_self_narrative', label: 'Future Self Narrative', weight: 20 },
