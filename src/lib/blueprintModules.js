...
export const BLUEPRINT_MODULES = [
  ...
  },
  {
    ...
    shortLabel: 'Coach',
    description: 'Discover ambition, impact, values, and future self.',
    navGroup: 'foundation',
    tracks: ['agency_builder', 'specialist_consultant'],
  },
  {
    ...
    shortLabel: 'Ambition',
    description: 'Ambition, impact, values, and future self.',
    navGroup: 'foundation',
    tracks: ['agency_builder', 'specialist_consultant'],
    progressWeights: [
      { key: 'vision_statement', label: 'My Ambition', weight: 16 },
      { key: 'mission_statement', label: 'My Impact', weight: 16 },
      { key: 'my_values', label: 'My Values', weight: 16 },
      { key: 'personal_tagline', label: 'My Tagline', weight: 16 },
      { key: 'future_self_narrative', label: 'Future Self Narrative', weight: 16 },
      { key: 'dream_board', label: 'Dream Board', weight: 20 },
    ],
  },
  {
    slug: 'canvas',
