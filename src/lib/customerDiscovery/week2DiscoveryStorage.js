...
export function defaultWeek2State() {
  return {
    ...
    empathySquadInsight: '',
    empathyKeyTakeaways: '',
    empathyAdvisorConnection: '',
    empathyLabCompletedAt: null,
    cloudSyncedAt: null,
    updatedAt: null,
  };
}
...
export function loadWeek2Discovery(participantId) {
  ...
  return {
    ...
    empathyThinking: stored.empathyThinking ?? '',
    empathyFeeling: stored.empathyFeeling ?? '',
    empathyWorries: stored.empathyWorries ?? '',
    empathyAvoiding: stored.empathyAvoiding ?? '',
    empathyWants: stored.empathyWants ?? '',
    empathySquadInsight: stored.empathySquadInsight ?? '',
    empathyKeyTakeaways: stored.empathyKeyTakeaways ?? '',
    empathyAdvisorConnection: stored.empathyAdvisorConnection ?? '',
    empathyLabCompletedAt: stored.empathyLabCompletedAt ?? null,
