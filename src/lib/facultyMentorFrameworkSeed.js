...
export const FACULTY_DAY_TEMPLATES_SEED = [
  {
    ...
    learning_objectives: [
      'Deliver Program Coach Deck 01 — AIA, Agency, and SPIKE stories',
      'Deliver Program Coach Deck 02 — Ambition, Impact, Values, Future Self, Career Direction',
  ...
  },
  {
    ...
    learning_objectives: [
      ...
      'Present persona to program coach',
    ],
  ...
  },
  {
    ...
    learning_objectives: [
      ...
      'Draft Unified Venture Proposition (Venture Design Studio)',
      'Present UVP snapshot',
    ],
    key_concepts: ['Advisor vs Entrepreneur', 'Agency Builder', 'Specialist Consultant', 'Unified Venture Proposition'],
    speaker_notes: 'Venture Design Studio workshop. Day 4 target: drafted UVP (Step 3), not FEC completion %.',
    discussion_questions: [
    ...
    rubrics: ['UVP & Venture Design rubric', 'UVP presentation rubric'],
    expected_outputs: ['Unified Venture Proposition', 'Career Direction checkpoint'],
    status: 'published',
  },
  {
    id: 'faculty-s1-w1-d5',
...
export const MENTOR_DAY_GUIDES_SEED = [
  ...
  },
  {
    ...
    day: 4,
    theme: 'Entrepreneur',
    coaching_objective: 'Coach squads to draft a clear Unified Venture Proposition.',
    discussion_questions: [
      'Who does your venture serve?',
      'What is your one-sentence UVP?',
      'Would you rather build a Practice, build a Team, or build an Agency? Why?',
    ],
    observation_areas: ['UVP Clarity', 'Ownership', 'Entrepreneurial Thinking'],
    reflection_prompts: ['What is your UVP in one sentence today?'],
    warning_signs: ['Generic customer segment', 'Skipping Step 3 UVP synthesis'],
    coaching_tips: ['Day 4 target is UVP — not FEC completion percentage'],
    expected_outcomes: ['Unified Venture Proposition (Venture Design Studio)'],
    status: 'published',
  },
  {
    id: 'mentor-s1-w1-d5',
