    ...
    <PageContainer wide>
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <section className="rounded-2xl border border-spike/20 bg-gradient-to-br from-spike-muted/50 to-white p-5">
          ...
          <p className="mt-1 text-sm text-slate-600">
            Batches are mixed-agency — rookies choose home agency and unit at signup (Cebu Matunog and
            Cebu Ez Premier units welcome in one batch).
          </p>
          <p className="mt-3 text-sm text-slate-600">
            {raInterns.length
              ? `${raInterns.length} participant${raInterns.length === 1 ? '' : 's'} in this portal view.`
              : 'No participants enrolled yet — create a batch and share the invite code.'}
          </p>
